...
class CreateTBLUSRTable extends weMigrations
{
    ...
    public function up()
    {
        ...
        Schema::create('TBLUSR', function ($table) {
            ...
            $table->integer('TUCOMSIY')->nullable(false)->comment('System Company IY');
            ...
            $table->primary(['TUCOMSIY','TUUSERIY']);  
            $table->unique(array('TUCOMSIY','TUUSER'));           
            $table->foreign('TUCOMSIY')->references('SCCOMSIY')->on('SYSCOM');
        }); 
