...
class SHLINE extends weModel
{
     ...
     * @var array
     */
    protected $fillable = ['SLSLNO', 'SLSHNOIY', 'SLITNOIY', 'SLQTYS', 'SLHARG', 'SLTOTL', 'SLREMK', 'SLRGID', 'SLRGDT', 'SLCHID', 'SLCHDT', 'SLCHNO', 'SLDLFG', 'SLDPFG', 'SLPTFG', 'SLPTCT', 'SLPTID', 'SLPTDT', 'SLSRCE', 'SLUSRM', 'SLITRM', 'SLCSDT', 'SLCSID', 'SLCSNO'];
