...
class TBLUSR extends weModel
{
     ...
     * @var array
     */
    protected $fillable = ['TUUSER', 'TUNAME', 'TUPSWD', 'TUEMID', 'TUDEPT', 'TUMAIL', 'TUWELC', 'TUEXPP', 'TUEXPD', 'TUEXPV', 'TULGCT', 'TULSLI', 'TULSLO', 'TUFOTO', 'TUREMK', 'TURGID', 'TURGDT', 'TUCHID', 'TUCHDT', 'TUCHNO', 'TUDLFG', 'TUDPFG', 'TUPTFG', 'TUPTCT', 'TUPTID', 'TUPTDT', 'TUSRCE', 'TUUSRM', 'TUITRM', 'TUCSDT', 'TUCSID', 'TUCSNO'];
    ...
    {
        return $this->belongsTo('App\Models\Syscom', 'TUCOMSIY', 'SCCOMSIY');
    }
}
